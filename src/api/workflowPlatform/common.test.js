...
describe('common', () => {
  ...
  describe('acquireToken', () => {
    it('returns token when no errors occur', async () => {
      ...
      const expectedRequest = { scopes: fakeMsalConfig.workflowPlatformApi.scopes, account: fakeAccount };
  ...
  describe('patchResource', () => {
    ...
    it('invokes handleApiError when an error occurs', async () => {
      ...
      // * ACT
      await expect(api.patchResource(resourceName, resourceId, queryParams, data)).rejects.toThrow();
