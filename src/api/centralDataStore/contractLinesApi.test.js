...
import contractLinesApi from './contractLinesApi';
...
describe('ContractLinesApi', () => {
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'contractLines';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await contractLinesApi.get(defaultParams);
    ...
    it('returns results from the api', async () => {
      const actual = await contractLinesApi.get(defaultParams);
