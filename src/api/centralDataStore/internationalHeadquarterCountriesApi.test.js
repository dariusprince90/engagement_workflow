...
import internationalHeadquarterCountriesApi from './internationalHeadquarterCountriesApi';
...
describe('InternationalHeadquarterCountriesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'internationalHeadquarterCountries';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await internationalHeadquarterCountriesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await internationalHeadquarterCountriesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await internationalHeadquarterCountriesApi.get(defaultParams);
