...
import newBillingSchedulesApi from './newBillingSchedulesApi';
...
describe('NewBillingSchedulesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'newBillingSchedules';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await newBillingSchedulesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await newBillingSchedulesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await newBillingSchedulesApi.get(defaultParams);
  ...
  describe('getBillingSchedule', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await newBillingSchedulesApi.getBillingSchedule(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await newBillingSchedulesApi.getBillingSchedule(id, fields);
