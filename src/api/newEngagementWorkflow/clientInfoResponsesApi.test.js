...
import clientInfoResponsesApi from './clientInfoResponsesApi';
...
describe('ClientInfoResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'clientInfoResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await clientInfoResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await clientInfoResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await clientInfoResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getClientInfoResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await clientInfoResponsesApi.getClientInfoResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await clientInfoResponsesApi.getClientInfoResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await clientInfoResponsesApi.patch(id, data, etag);
    ...
    it('returns results from the api', async () => {
      const actual = await clientInfoResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await clientInfoResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await clientInfoResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
