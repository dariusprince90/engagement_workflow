...
import clientPrivateEquitiesApi from './clientPrivateEquitiesApi';
...
describe('ClientPrivateEquitiesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('delete', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'clientPrivateEquities';
      const expectedParams = { apiVersion: 1 };

      // * ACT
      await clientPrivateEquitiesApi.delete(id, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await clientPrivateEquitiesApi.delete();
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await clientPrivateEquitiesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await clientPrivateEquitiesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await clientPrivateEquitiesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getClientPrivateEquity', () => {
    const id = faker.datatype.number();
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await clientPrivateEquitiesApi.getClientPrivateEquity(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await clientPrivateEquitiesApi.getClientPrivateEquity(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await clientPrivateEquitiesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await clientPrivateEquitiesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await clientPrivateEquitiesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await clientPrivateEquitiesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await clientPrivateEquitiesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
