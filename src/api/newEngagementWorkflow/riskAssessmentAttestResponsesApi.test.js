...
import riskAssessmentAttestResponsesApi from './riskAssessmentAttestResponsesApi';
...
describe('RiskAssessmentAttestResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'riskAssessmentAttestResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await riskAssessmentAttestResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await riskAssessmentAttestResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await riskAssessmentAttestResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getRiskAssessmentAttestResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await riskAssessmentAttestResponsesApi.getRiskAssessmentAttestResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await riskAssessmentAttestResponsesApi.getRiskAssessmentAttestResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await riskAssessmentAttestResponsesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await riskAssessmentAttestResponsesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await riskAssessmentAttestResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await riskAssessmentAttestResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await riskAssessmentAttestResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
