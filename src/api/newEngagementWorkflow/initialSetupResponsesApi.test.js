...
import initialSetupResponsesApi from './initialSetupResponsesApi';
...
describe('InitialSetupResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'initialSetupResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await initialSetupResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await initialSetupResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await initialSetupResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getInitialSetupResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await initialSetupResponsesApi.getInitialSetupResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await initialSetupResponsesApi.getInitialSetupResponse(id, fields);
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await initialSetupResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await initialSetupResponsesApi.post(data);
