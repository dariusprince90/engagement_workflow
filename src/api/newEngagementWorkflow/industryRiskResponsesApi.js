...
class IndustryRiskResponsesApi {
  static async get({ pageSize, pageNumber, filter, searchQuery, orderBy, fields } = {}) {
    const resourceName = 'industryRiskResponses';
    const apiVersion = 1;
  ...
  static async getIndustryRiskResponse(id, fields) {
    const resourceName = 'industryRiskResponses';
    const apiVersion = 1;
...
export default IndustryRiskResponsesApi;
