...
class KnowledgeOfClientAllClientsResponsesApi {
  static async get({ pageSize, pageNumber, filter, searchQuery, orderBy, fields } = {}) {
    const resourceName = 'knowledgeOfClientAllClientsResponses';
    const apiVersion = 1;
  ...
  static async getKnowledgeOfClientAllClientsResponse(id, fields) {
    const resourceName = 'knowledgeOfClientAllClientsResponses';
    const apiVersion = 1;
...
export default KnowledgeOfClientAllClientsResponsesApi;
