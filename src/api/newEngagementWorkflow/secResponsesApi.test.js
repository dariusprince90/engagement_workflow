...
import secResponsesApi from './secResponsesApi';
...
describe('SecResponsesApi', () => {
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'secResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await secResponsesApi.get(defaultParams);
    ...
    it('returns results from the api', async () => {
      const actual = await secResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getSecResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await secResponsesApi.getSecResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await secResponsesApi.getSecResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await secResponsesApi.patch(id, data, etag);
    ...
    it('returns results from the api', async () => {
      const actual = await secResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await secResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await secResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
