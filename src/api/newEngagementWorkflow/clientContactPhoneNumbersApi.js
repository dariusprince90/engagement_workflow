...
class ClientContactPhoneNumbersApi {
  static async delete(id, etag) {
    const resourceName = 'clientContactPhoneNumbers';
    const apiVersion = 1;
  ...
  static async getClientContactPhoneNumber(id, fields) {
    const resourceName = 'clientContactPhoneNumbers';
    const apiVersion = 1;
...
export default ClientContactPhoneNumbersApi;
