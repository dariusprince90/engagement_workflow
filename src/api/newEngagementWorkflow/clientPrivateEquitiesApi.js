...
class ClientPrivateEquitiesApi {
  static async delete(id, etag) {
    const resourceName = 'clientPrivateEquities';
    const apiVersion = 1;
  ...
  static async getClientPrivateEquity(id, fields) {
    const resourceName = 'clientPrivateEquities';
    const apiVersion = 1;
...
export default ClientPrivateEquitiesApi;
