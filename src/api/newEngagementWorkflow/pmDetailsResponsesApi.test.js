...
import pmDetailsResponsesApi from './pmDetailsResponsesApi';
...
describe('PmDetailsResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'pmDetailsResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await pmDetailsResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await pmDetailsResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await pmDetailsResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getPmDetailsResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await pmDetailsResponsesApi.getPmDetailsResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await pmDetailsResponsesApi.getPmDetailsResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await pmDetailsResponsesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await pmDetailsResponsesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await pmDetailsResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await pmDetailsResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await pmDetailsResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
