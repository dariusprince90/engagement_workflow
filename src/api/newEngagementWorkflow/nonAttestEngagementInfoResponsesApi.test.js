...
import nonAttestEngagementInfoResponsesApi from './nonAttestEngagementInfoResponsesApi';

// **********************************************************************
// * constants

const fakeQueryParams = faker.random.alphaNumeric(10);
const fakeResource = faker.datatype.string();
...
describe('NonAttestEngagementInfoResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'nonAttestEngagementInfoResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await nonAttestEngagementInfoResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await nonAttestEngagementInfoResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await nonAttestEngagementInfoResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getNonAttestEngagementInfoResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await nonAttestEngagementInfoResponsesApi.getNonAttestEngagementInfoResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await nonAttestEngagementInfoResponsesApi.getNonAttestEngagementInfoResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await nonAttestEngagementInfoResponsesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await nonAttestEngagementInfoResponsesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await nonAttestEngagementInfoResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await nonAttestEngagementInfoResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await nonAttestEngagementInfoResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
