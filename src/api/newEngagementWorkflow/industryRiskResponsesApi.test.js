...
import industryRiskResponsesApi from './industryRiskResponsesApi';
...
describe('IndustryRiskResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'industryRiskResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await industryRiskResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await industryRiskResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await industryRiskResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getIndustryRiskResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await industryRiskResponsesApi.getIndustryRiskResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await industryRiskResponsesApi.getIndustryRiskResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await industryRiskResponsesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await industryRiskResponsesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await industryRiskResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await industryRiskResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await industryRiskResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
