...
class KnowledgeOfClientNewClientsResponsesApi {
  static async get({ pageSize, pageNumber, filter, searchQuery, orderBy, fields } = {}) {
    const resourceName = 'knowledgeOfClientNewClientsResponses';
    const apiVersion = 1;
  ...
  static async getKnowledgeOfClientNewClientsResponse(id, fields) {
    const resourceName = 'knowledgeOfClientNewClientsResponses';
    const apiVersion = 1;
...
export default KnowledgeOfClientNewClientsResponsesApi;
