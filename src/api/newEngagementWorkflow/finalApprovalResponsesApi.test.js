...
import finalApprovalResponsesApi from './finalApprovalResponsesApi';
...
describe('FinalApprovalResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'finalApprovalResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await finalApprovalResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await finalApprovalResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await finalApprovalResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getFinalApprovalResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await finalApprovalResponsesApi.getFinalApprovalResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await finalApprovalResponsesApi.getFinalApprovalResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await finalApprovalResponsesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await finalApprovalResponsesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await finalApprovalResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await finalApprovalResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await finalApprovalResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
