...
import jobInfoResponsesApi from './jobInfoResponsesApi';
...
describe('JobInfoResponsesApi', () => {
  ...
  describe('delete', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'jobInfoResponses';
      const expectedParams = { apiVersion: 1 };

      // * ACT
      await jobInfoResponsesApi.delete(id, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await jobInfoResponsesApi.delete();
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await jobInfoResponsesApi.get(defaultParams);
    ...
    it('returns results from the api', async () => {
      const actual = await jobInfoResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getJobInfoResponse', () => {
    const id = faker.datatype.number();
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await jobInfoResponsesApi.getJobInfoResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await jobInfoResponsesApi.getJobInfoResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await jobInfoResponsesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await jobInfoResponsesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await jobInfoResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await jobInfoResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await jobInfoResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
