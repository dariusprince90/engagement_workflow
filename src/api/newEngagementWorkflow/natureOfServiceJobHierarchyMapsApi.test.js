...
import natureOfServiceJobHierarchyMapsApi from './natureOfServiceJobHierarchyMapsApi';
...
describe('NatureOfServiceJobHierarchyMapsApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'natureOfServiceJobHierarchyMaps';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await natureOfServiceJobHierarchyMapsApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await natureOfServiceJobHierarchyMapsApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await natureOfServiceJobHierarchyMapsApi.get(defaultParams);
