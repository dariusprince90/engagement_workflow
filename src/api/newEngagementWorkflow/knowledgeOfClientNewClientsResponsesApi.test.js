...
import knowledgeOfClientNewClientsResponsesApi from './knowledgeOfClientNewClientsResponsesApi';
...
describe('KnowledgeOfClientNewClientsResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'knowledgeOfClientNewClientsResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await knowledgeOfClientNewClientsResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await knowledgeOfClientNewClientsResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await knowledgeOfClientNewClientsResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getKnowledgeOfClientNewClientsResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await knowledgeOfClientNewClientsResponsesApi.getKnowledgeOfClientNewClientsResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await knowledgeOfClientNewClientsResponsesApi.getKnowledgeOfClientNewClientsResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await knowledgeOfClientNewClientsResponsesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await knowledgeOfClientNewClientsResponsesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await knowledgeOfClientNewClientsResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await knowledgeOfClientNewClientsResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await knowledgeOfClientNewClientsResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
