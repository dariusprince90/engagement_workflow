...
import knowledgeOfClientAllClientsResponsesApi from './knowledgeOfClientAllClientsResponsesApi';
...
describe('KnowledgeOfClientAllClientsResponsesApi', () => {
  // **********************************************************************
  // * setup
  ...
  describe('get', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      // * ARRANGE
      const expectedResourceName = 'knowledgeOfClientAllClientsResponses';
      const expectedParams = { apiVersion: 1, ...defaultParams };

      // * ACT
      await knowledgeOfClientAllClientsResponsesApi.get(defaultParams);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await knowledgeOfClientAllClientsResponsesApi.get();
    ...
    it('returns results from the api', async () => {
      const actual = await knowledgeOfClientAllClientsResponsesApi.get(defaultParams);
      expect(actual).toBe(fakeResourceCollection);
    });
  });

  describe('getKnowledgeOfClientAllClientsResponse', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await knowledgeOfClientAllClientsResponsesApi.getKnowledgeOfClientAllClientsResponse(id, fields);
    ...
    it('returns results from the api', async () => {
      const actual = await knowledgeOfClientAllClientsResponsesApi.getKnowledgeOfClientAllClientsResponse(id, fields);
  ...
  describe('patch', () => {
    ...
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await knowledgeOfClientAllClientsResponsesApi.patch(id, data, etag);
    ...
    it('invokes api methods with correct parameters when no params are passed', async () => {
      ...
      // * ACT
      await knowledgeOfClientAllClientsResponsesApi.patch();
    ...
    it('returns results from the api', async () => {
      const actual = await knowledgeOfClientAllClientsResponsesApi.patch(id, data, etag);
      expect(actual).toBe(fakeResource);
    });
  });
  ...
  describe('post', () => {
    it('invokes api methods with correct parameters', async () => {
      ...
      // * ACT
      await knowledgeOfClientAllClientsResponsesApi.post(data);
    ...
    it('returns results from the api', async () => {
      const data = { [faker.random.alpha(5)]: faker.random.alphaNumeric(10) };
      const actual = await knowledgeOfClientAllClientsResponsesApi.post(data);
      expect(actual).toBe(fakeResource);
    });
  });
});
