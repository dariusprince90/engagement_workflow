...
export default {
  title: 'Components/Common/CollapsibleFormSection',
  component: CollapsibleFormSection,

  args: {
    title: 'Suspendisse turpis felis',
    children: ''
  },

  argTypes: {
    children: { table: { type: { summary: 'string' } }, control: 'text' }
  },

  parameters: {
    docs: {
      source: { type: 'dynamic', excludeDecorators: true },
      description: { component: 'A collapsible component with a title and content' }
    }
  },
...
const Template = (args) => {
  ...
  return (
    <CollapsibleFormSection {...props}>
      <div className="container-fluid">{args.children || content}</div>
